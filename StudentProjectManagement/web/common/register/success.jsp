<%-- 
    Document   : success
    Created on : Aug 25, 2022, 5:41:27 PM
    Author     : trung
--%>
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <div style="height: 530px; align-items: center;">
                                    ...
                                    <a href="${pageContext.request.contextPath}/login" class="form-text">
                                        <h5 style="color: green;text-align: center">Verified success! Click here to login.</h5>
                                    </a>
                                </div>
