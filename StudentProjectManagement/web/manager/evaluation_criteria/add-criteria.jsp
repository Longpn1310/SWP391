                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Add New New Criteria</h1>  
                        </div>
                        <form method="POST" action="${pageContext.request.contextPath}/criteria">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                    <div class="form-group">       
                                        <label>Criteria Name<span style="color:red">*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">       
                                        ...
                                        <div >
                                            ...
                                            <input type="radio"  name="options" name="teamEval" checked="${!criteria.isTeamEval ? "checked" : ""}" autocomplete="off" value="false" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">       
                                        <label>Max loc<span style="color:red">*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">       
                                        ...
                                        <select  name="status" class="custom-select">
                                            <option value="true" ${criteria.status ? "selected":""}>Active</option>
                                            <option value="false" ${!criteria.status ? "selected" :""}>Deactive</option>                                                                               
                                        </select>     
                                    </div>
                                </div>
