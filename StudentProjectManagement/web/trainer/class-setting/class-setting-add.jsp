                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <h1 class="h3 mb-0 text-gray-800">Add new class setting</h1>  
                                          
                        </div>
                        <form method="POST" action="${pageContext.request.contextPath}/class-setting">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">       
                                        ...
                                        <input id="settingType" name="settingValue" class="form-control" required/>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">       
                                        <label >Display Order *</label>
                                        <input  name="displayOrder" type="number"  class="form-control" required/>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">       
