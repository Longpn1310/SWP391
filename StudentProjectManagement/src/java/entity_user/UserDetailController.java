...
public class UserDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/admin/user/user-detail.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String fb = request.getParameter("avatar_link");
//        dao.updateUser(id, rollnumber, name, phone, email,avatar, status,fb);
