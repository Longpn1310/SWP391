 ...
 * @author HaiLong
 */
public class TeamDashboardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int teamId = dao.getTeamId(userId);
        request.setAttribute("teamGrades", dao.getByUserId(userId));
        request.setAttribute("map", dao.getAllTeamSubmiStatus(teamId));
